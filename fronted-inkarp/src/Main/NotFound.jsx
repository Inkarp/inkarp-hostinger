            ...
            <div className="container min-h-screen px-6 py-12 mx-auto flex flex-col lg:flex-row items-center lg:gap-12">
                <div className="w-full lg:w-1/2">
                    ...
                    <div className="flex items-center mt-6 gap-4 flex-wrap">
                        ...
                        <Link
                            to="/"
                            className="px-5 py-2 text-sm font-medium text-white bg-[#Be0010] rounded-lg hover:bg-blue-700 transition"
                        >
                            Take me home
                        </Link>
                    </div>
                    ...
                    <div className="mt-10 space-y-6">
                        <div>
                            <Link
                                to="/verticals"
                                className="inline-flex items-center text-sm text-[#E63946] gap-x-2 dark:text-blue-400 hover:underline"
                            >
