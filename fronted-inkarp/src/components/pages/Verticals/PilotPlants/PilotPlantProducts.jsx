...
// Principal Logos (keep your existing paths)
...
// (These Mettler images were unused; safe to remove if not needed elsewhere)
...
// Map principals to their tabs for logo resolution (like the sample)
const synthesisData = [
  {
...
const synthesisProducts = {
  ...PilotPlants, // expect keys like: stirred-reactor-plants, catalyst-testing-plant
};
