    ...
    <section className="relative w-[98%] mx-auto p-5">
      ...
      <div className="lg:hidden mt-5 relative max-w-xl mx-auto">
        ...
        >
          ...
          {mobileOpen ? (
            <ChevronUp size={50} className=" text-[#E63946]" />
          ) : (
            <ChevronDown size={50} className=" text-[#E63946]" />
          )}
        </button>
          ...
          <div className="lg:col-span-6">
            ...
            >
              <div className="flex flex-col gap-6">
                {/* Responsive image area with aspect ratio */}
                ...
                {/* Text grows naturally with content */}
