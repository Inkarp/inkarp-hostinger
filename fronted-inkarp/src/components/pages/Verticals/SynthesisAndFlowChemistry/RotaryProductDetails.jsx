        ...
        <div className="block md:hidden bg-gray-50 p-4 rounded-xl border">
          <div className="flex items-center gap-4">
            <div className="w-1/3 shrink-0">
              <img
                src={product.image}
                alt={`${product?.name ?? 'Product'}_Heidolph_Inkarp`}
                loading="lazy"
            ...
            <div className="w-2/3 space-y-2">
              ...
              <h1 className="text-md font-bold font-[MaxOT] text-gray-900 leading-tight">{product.name} Distributor and Service Provider In India</h1>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:block relative w-full">
          ...
          <div className="absolute inset-0 flex flex-row items-center justify-around p-4">
            <div className="w-1/2 flex justify-start">
              <img src={product.image}   alt={`${product?.name ?? 'Product'}_Heidolph_Inkarp`} className="w-[60%] h-auto object-cover rounded-lg" />
            </div>
