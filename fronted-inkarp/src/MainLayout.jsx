...
import { ChevronUp, Facebook, Linkedin, Instagram, Youtube, Rss } from "lucide-react"
  ...
  return (
      ...
      <div className="flex min-h-screen w-full overflow-hidden">
        ...
        {location.pathname === "/" && atTop && (
          <button
            ...
            className="
      fixed top-3 left-16 z-30 flex items-center
    ...
    "
        ...
        <button
          ...
          className="
    fixed top-3 left-4 z-30 p-2
    flex items-center justify-center
    bg-[#F5F5F5] lg:hidden rounded-md shadow-md 
  "
        >
          ...
          <div className="relative flex flex-col min-h-screen z-10">
            <main className="flex-grow relative">
              ...
              {location.pathname === "/" && (
                <>
                  ...
                  {!showPopup && (
                    <div
                      className={`fixed bottom-20 left-0 md:left-65 z-[10001] bg-[#E63946] text-white p-3.5 rounded-full shadow-lg cursor-pointer transition-transform hover:scale-110 ${iconAnimate ? 'animate-bounce' : ''}`}
              ...
              <div
                className="fixed bottom-6 left-5 md:left-65 z-[9999] group"
              ...
              >
                ...
                <div
                  className={`absolute bottom-0 left-5 ${showWhatsApp || hovered ? "animate-slideIn" : "animate-slideOut"
                    }`}
                >
                  <a
            ...
            {showScrollTop && (
              <>
                <div
                  className="
                    fixed right-2 top-1/4 z-[9999]  flex
                    flex-col items-stretch
                    rounded-md border border-gray-200 bg-white/95 shadow
                    overflow-hidden
                  "
                  role="navigation"
                ...
                className="
      grid place-items-center p-2 border-t border-gray-200
      hover:bg-gray-50 active:scale-95 transition
    "
                aria-label="Go to top"
                title="Go to top"
              >
                <div className="w-6 h-6 grid place-items-center rounded-full border border-gray-400 text-gray-700">
                  <ChevronUp size={14} />
                </div>
              </button> */}
                  ...
                  <button
                    onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
                    className="cursor-pointer  z-[99999] group/button active:scale-95 grid place-items-center"
                    aria-label="Go to top"
                  >
                    {(() => {
                      const r = 24; // radius
                      ...
                      return (
                        <svg className="w-8 h-10 -rotate-90" viewBox="0 0 56 56">
                          {/* track */}
                          <circle
                            cx="28"
                            cy="28"
                    ...
                    <span className="pointer-events-none absolute text-[#E63946] text-[8px] font-medium rotate-0">
