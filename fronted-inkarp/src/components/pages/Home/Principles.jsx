...
const logoRings = [
  ...
  // Row Four
  [
    { name: "Anvajo", src: Anvajo ,link:"/verticals/lifesciences"},
  ...
  [
    ...
    { name: "AP", src: AP,link:"/verticals/pilot-plants-and-automation" },
    ...
    { name: "Innova", src: Innova,link:"/verticals/general-laboratory-instrument"  },
  ],
  // Row Seven
  [
